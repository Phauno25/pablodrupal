...
(function ($, Drupal) {
    Drupal.behaviors.myModuleBehavior = {
      attach: function (context, settings) {
        ...
        $tipoCaso = ["Perdido", "Robado"];
        $sexo = ["Macho", "Hembra"];
        $animal =["Perros", "Gatos", "Otros"];
        $raza = [
            "Pitbull Terrier", "Border Collie", "Golden Retriever", "Mestizo", "Schnowzer Mini", "Boxer", "BullDog Frances", "Cocker", "Caniche", "Labrador Retriever",
            "Balinés", "Bengal", "Bosque de Noruega", "Britanico", "Cornish Rex", "Devon Rex", "Exótico", "Maine Coon", "Común Europeo (mestizo)", "Abisinio", "Otro"
        ];
