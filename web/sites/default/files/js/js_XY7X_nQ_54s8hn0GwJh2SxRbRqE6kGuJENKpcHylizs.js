    ...
    Drupal.behaviors.myModuleBehavior = {
        attach: function (context, settings) {
            ...
            $(document).ready(function () {
                console.log("Js de portal");

                if ($('#form-portal-autenticidad').find('input[name="numero_documento"]').val() > 0) {
                    $('#form-portal-autenticidad').hide();
                }
                console.log($('#form-portal-autenticidad'))
                
                let form = document.getElementById('form-portal-autenticidad');
                let btb = document.getElementById('btnSubmit');
                $('#btnSubmit', context).once('myModuleBehavior').on('click', function () {
            ...
            /* $('#btnSubmit').click(function (e) { 
                ...
                /$.ajax({
                    type: "GET",
                    url: "/drupal/portal_autenticidad/getdocumentopdf",
                    dataType: "json",
